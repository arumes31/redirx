...
class Config:
    ...
    PHISHING_LIST_URL = os.environ.get('PHISHING_LIST_URL', 'https://raw.githubusercontent.com/mitchellkrogza/Phishing.Database/master/phishing-domains-ACTIVE.txt')
